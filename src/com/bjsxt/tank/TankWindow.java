...
public class TankWindow extends Frame
{
	...
	public TankWindow(int width, int heigth, String title)
	{
		...
		exit.addActionListener(new actionListeners());
		// 关闭窗口
		...
		for (int i = 0; i < 10; i++)
		{
			Tank t = new Tank(150 + 50 * i, 60, false, Direction.D, this);
			enemyTanks.add(t);
		}
	...
	public void paint(Graphics g)
	{
		...
		if (enemyTanks.isEmpty())
		{
			for (int i = 0; i < 10; i++)
			{
				Tank t = new Tank(150 + 50 * i, 60, false,Direction.D,
						this);
				enemyTanks.add(t);
			}
		}
		...
		g.drawString("我军的生命值：" + myTank.getLife(), 30, 140);
	}
